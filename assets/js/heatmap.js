...
// Strava GPS exports.
//
// The track file is cropped by _tools/crop_heatmap_privacy.py before it is
// committed. Strava applies privacy zones to its own map view and NOT to the
// summary polyline in an export, so an uncropped export still starts and ends
// on the doorstep. Re-run that tool on any regenerated export; do not commit
// a raw one.
(function () {
  "use strict";
